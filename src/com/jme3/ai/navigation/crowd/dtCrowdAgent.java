...
public class dtCrowdAgent {
    ...
    public void setCorridor(PathCorridor value) {
        RecastJNI.dtCrowdAgent_corridor_set(swigCPtr, this, PathCorridor.getCPtr(value), value);
    }

    public PathCorridor getCorridor() {
        long cPtr = RecastJNI.dtCrowdAgent_corridor_get(swigCPtr, this);
        return (cPtr == 0) ? null : new PathCorridor(cPtr, false);
    }
