...
import com.jme3.ai.recast.utils.UShortArray;
...
public class CompactHeightfield {
    ...
    public void setAreas(char[] value) {
        SWIGTYPE_p_unsigned_char v = Converter.convertToSWIGTYPE_p_unsigned_char(value);
        RecastJNI.rcCompactHeightfield_areas_set(swigCPtr, this, SWIGTYPE_p_unsigned_char.getCPtr(v));
    }
